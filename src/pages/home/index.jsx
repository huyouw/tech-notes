                ...
                <section className="top-section">
                    ...
                    <div className="vertical-middle">
                        ...
                        <div className="button-area">
                            {
                                dataSource.brand.buttons.map(b => (<Button
type={b.type} key={b.type} link={b.link}
                                                                          target={b.target}
                                >{b.text}</Button>))
                            }
                        </div>
                ...
                {/* <section className="start-section">
                    <div className="start-body">
                        <div className="left-part">
                            ...
                            <a href={getLink(dataSource.start.button.link)}
                               target={dataSource.start.button.link || '_self'}>{dataSource.start.button.text}</a>
                        </div>
